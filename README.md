...
def process_video_with_esrgan(test_vid=None, model_path=None):
    ...
    for path in glob.glob(test_vid):
        ...
        out = cv2.VideoWriter(r'C:\Users\<YourUsername>\Downloads\{:s}_ESRGAN.avi'.format(base),
                              fourcc,
                              FPS,
        ...
        pathop =r'C:\Users\<YourUsername>\Downloads\{:s}_ESRGAN.avi'.format(base)
...
#MODEL PATH(VID_Ttune2-2.pth is base model)
model=r"C:\Users\<YourUsername>\Downloads\VID_tune2-2.pth"  
